...
namespace TwistedLogik.Ultraviolet.OpenGL
{
    ...
    public sealed class OpenGLUltravioletContext : UltravioletContext
    {
            ...
            : base(host, configuration)
        {
            ...
            {
                String.IsNullOrEmpty(configuration.ViewProviderAssembly) ? null : Assembly.Load(new AssemblyName(configuration.ViewProviderAssembly))
            });
        ...
        private IUltravioletAudio InitializeAudioSubsystem(OpenGLUltravioletConfiguration configuration)
        {
            ...
            try
            {
                asm = Assembly.Load(new AssemblyName(configuration.AudioSubsystemAssembly));
